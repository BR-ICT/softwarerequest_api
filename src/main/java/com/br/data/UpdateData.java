...
public class UpdateData {
  ...
  public static String updateMARHead(String cono, String divi, String marno, String date,
      String postdate, String month, String type, String prefix, String bu, String costcenter,
      String accountant, String requestor, String remark, String purpose, String approve1,
      String approve2, String approve3, String approve4, String approve5, String acknoict,
      String acknocio, String status, String submit, String username) throws Exception {
  ...
  public static String resendemail(String cono, String divi, String serviceno) throws Exception {
    ...
    try {
      ...
      /*
       * if (data != null && data.trim().startsWith("{")) { JSONObject json = new JSONObject(data);
       * json.put("vApproval", true); data = json.toString(); }
       */
  ...
  public static String prepareUpdateSWRQ(String vID, String vSTATUS, String vData, String vApproval,
      String vApprover, String vDepthead, String vRemark) throws Exception {
    ...
    try {
      ...
      String checkSQL = "SELECT FAAPBY " + "FROM " + DBNAME + ".SR_FLOWAPPROVE "
          + "WHERE FACODE = 'SWRQ' " + "AND FASRNO = '" + vID + "' " + "AND FASTAT = '" + vSTATUS
          + "'  AND FACONO = '" + comcono + "'" + "FETCH FIRST 1 ROWS ONLY";
      ...
      if ("false".equalsIgnoreCase(vApproval)) {
        ...
        FADES = "FADES4";
        rejectSWRQ(vID, vSTATUS, vData, vApproval, vApprover, vDepthead, vRemark, Status, comcono,
            comdivi);
      } else {
        switch (vSTATUS) {
          case "00":
            ...
            String querysetapprove = "UPDATE " + DBNAME + ".SR_FLOWAPPROVE \n" + "SET  FAAPLI = '"
          ...
          case "30":
            ...
            String querysetapprove2 = "UPDATE " + DBNAME + ".SR_FLOWAPPROVE \n" + "SET  FAAPLI = '"
                + vDepthead + "' \n" + "WHERE FACODE = 'SWRQ' AND FASRNO = '" + vID
                + "'  AND  FASTAT IN ('10') AND FACONO = '" + comcono + "' ";
          ...
          case "60":
            newStatus = "60";
            String completeSQL = "UPDATE " + DBNAME + ".SR_FLOWHEAD "
       ...
       * "', FDENDA = CURRENT DATE, FDENTI  = CURRENT TIME ,FDDSTA = '" + newStatus + "' \n" +
      ...
      String query222 = "UPDATE " + DBNAME + ".SR_FLOWAPPROVE \n" + "SET FAENUS = '" + vApprover
          ...
          + "WHERE FACODE = 'SWRQ' AND FASRNO = '" + vID + "' AND FASTAT  = '" + cStatus
          + "' AND FACONO = '" + comcono + "'";

      String query2 = "UPDATE " + DBNAME + ".SR_FLOWAPPROVE \n"
          + "SET   FAAPTI = CURRENT TIME ,  FAENUS = '" + vApprover
          + "' ,FADES1 = 'Approved',  FAAPDA = CURRENT DATE,FAENTI =  CURRENT TIME,FAAPBY = '"
          + vApprover + "' , " + FADES + " = '" + vRemark + "' , FAENDA = CURRENT DATE"
          + " WHERE FACODE = 'SWRQ' AND FASRNO = '" + vID + "' AND FASTAT = '" + Status
          + "' AND FACONO = '" + comcono + "' ";

      String query3 = "UPDATE " + DBNAME + ".SR_FLOWHEAD " + "SET   FHDSTA = '" + newStatus
          + "' , FHENDA = CURRENT DATE ,FHENTI = CURRENT TIME WHERE FHCODE = 'SWRQ' AND FHSRNO = '"
          + vID + "'  AND FHCONO = '" + comcono + "' AND FHDIVI = '" + comdivi + "'  ";

      String query = "UPDATE " + DBNAME + ".SR_FLOWDETAIL "
      ...
      if ("false".equalsIgnoreCase(vApproval)) {
        ...
        rejectreverseSWRQ(vID, vSTATUS, vData, vApproval, vApprover, vDepthead, vRemark, Status,
            FADES, comcono, comdivi);
  ...
  public static void UpdateSRMUserforinsert(String username, String MaxNo, String cono, String divi,
      String vDepthead) throws Exception {
    ...
    try {
      ...
      String querysetapprove1 = "UPDATE " + DBNAME + ".SR_FLOWAPPROVE \n" + "SET  FAAPLI = '"
      ...
      String querysetapprove3 = "UPDATE " + DBNAME + ".SR_FLOWAPPROVE \n" + "SET  FAAPLI = '"
          + username + "' \n" + "WHERE FACODE = 'SWRQ' AND FASRNO = '" + MaxNo + "' \n "
          + "AND  FASTAT IN ('40') \n" + "AND FACONO = '" + cono + "'\n " + "AND FADIVI = '" + divi
          + "'";
      ...
      String query222 = "UPDATE " + DBNAME + ".SR_FLOWAPPROVE \n" + "SET FAENUS = '" + username
          + "' ,FAAPBY = '" + vDepthead + "', FAAPDA = CURRENT DATE , FADES1 = 'Approved' \n"
          + "WHERE FACODE = 'SWRQ' AND FASRNO = '" + MaxNo + "' AND FASTAT  = '00' AND FACONO = '"
          + cono + "'";

      String query2 = "UPDATE " + DBNAME + ".SR_FLOWAPPROVE \n"
          + "SET   FAAPTI = CURRENT TIME ,  FAENUS = '" + username
          + "' ,FADES1 = 'Approved',  FAAPDA = CURRENT DATE,FAENTI =  CURRENT TIME,FAAPBY = '"
  ...
  public static void rejectreverseSWRQ(String vID, String vSTATUS, String vData, String vApproval,
      String vApprover, String vDepthead, String vRemark, String Status, String FADES,
      String comcono, String comdivi) throws Exception {
    ...
    String query2e = "UPDATE " + DBNAME + ".SR_FLOWAPPROVE \n"
        + "SET  FADES1 = 'Wait for approve', FAAPTI = null,FAAPBY = ' ', FAAPDA = NULL  ,FAENDA  = CURRENT DATE , FAENTI  = CURRENT TIME \n"
        + "WHERE FACODE = 'SWRQ' AND FASRNO = '" + vID
        + "'  AND  FASTAT IN ('10','15','20','30','40','50','60','70','80') AND FACONO = '"
        + comcono + "'";

    String query3e = "UPDATE " + DBNAME + ".SR_FLOWHEAD "
        + "SET FHDEPH = '-' WHERE FHCODE = 'SWRQ' AND FHSRNO = '" + vID + "'  AND FHCONO = '"
        + comcono + "' AND FHDIVI = '" + comdivi + "'  ";

    String query4re = "UPDATE " + DBNAME + ".SR_FLOWAPPROVE \n" + "SET  " + FADES + " = '" + vRemark
        + "' \n" + "WHERE FACODE = 'SWRQ' AND FASRNO = '" + vID + "'  AND  FASTAT = '" + Status
        + "' AND FACONO = '" + comcono + "' ";
  ...
  public static void rejectSWRQ(String vID, String vSTATUS, String vData, String vApproval,
      String vApprover, String vDepthead, String vRemark, String Status, String comcono,
      String comdivi) throws Exception {
    ...
    String query2e = "UPDATE " + DBNAME + ".SR_FLOWAPPROVE \n"
        ...
        + "WHERE FACODE = 'SWRQ' AND FASRNO = '" + vID
        + "'  AND  FASTAT IN ('00','10','20','30','40','50','60','70','80') AND  FACONO = '"
        + comcono + "' AND FADIVI = '" + comdivi + "' ";

    String query3e = "UPDATE " + DBNAME + ".SR_FLOWHEAD "
        + "SET FHDEPH = '-' WHERE FHCODE = 'SWRQ' AND FHSRNO = '" + vID + "'  AND FHCONO = '"
        + comcono + "'  ";

    String query4e = "UPDATE " + DBNAME + ".SR_FLOWAPPROVE \r\n"
        + "	SET  FARJDA  = CURRENT DATE , FARJTI  = CURRENT TIME , FARJBY = '" + vApprover
        + "' \r\n" + "	WHERE FACODE = 'SWRQ' AND FASRNO =  '" + vID + "'   AND  FASTAT = '"
        + Status + "' AND FACONO = '" + comcono + "'  ";
  ...
  public static String updateITEMREQUEST(String vID, String vSTATUS, String vData, String vApproval,
      String vApprover, String vDepthead, String vRemark) throws Exception {
    ...
    try {
      ...
      // เพิ่มก่อนเริ่ม update ใดๆ
      String checkSQL = "SELECT FAAPBY " + "FROM " + DBNAME + ".SR_FLOWAPPROVE "
          + "WHERE FACODE = 'ITRQ' " + "AND FASRNO = '" + vID + "' " + "AND FASTAT = '" + vSTATUS
          + "'  AND FACONO = '" + comcono + "'" + "FETCH FIRST 1 ROWS ONLY";
      ...
      if ("false".equalsIgnoreCase(vApproval)) {
        ...
        String query3e = "UPDATE " + DBNAME + ".SR_FLOWHEAD "
            + "SET FHDEPH = '-' WHERE FHCODE = 'ITRQ' AND FHSRNO = '" + vID + "'  AND FHCONO = '"
            + comcono + "'  ";

        String query4e = "UPDATE " + DBNAME + ".SR_FLOWAPPROVE \r\n"
            + "	SET  FARJDA  = CURRENT DATE , FARJTI  = CURRENT TIME , FARJBY = '" + vApprover
            + "' \r\n" + "	WHERE FACODE = 'ITRQ' AND FASRNO =  '" + vID + "'   AND  FASTAT = '"
            + Status + "' AND FACONO = '" + comcono + "'  ";
        ...
        switch (vSTATUS) {
          ...
          case "10":
            ...
            String querycheckapprovestatus =
                "SELECT CASE " + "        WHEN COUNT(*) > 0 THEN 'TRUE' " + "        ELSE 'FALSE' "
                    + "    END AS result " + "FROM " + DBNAME + ".SR_FLOWAPPROVE sf "
                    + "\n WHERE FACONO = '" + comcono + "' " + "  AND FACODE = 'ITRQ' "
             ...
             * 
             * else if (isVacant && newStatus == "15" && !isVacant) { newStatus = "15"; } else {
             * newStatus = "20"; }
             * 
             */
          ...
          case "80":
            newStatus = "22";
            String completeSQL2 = "UPDATE " + DBNAME + ".SR_FLOWHEAD "
                + "SET FHHSTA = 3 WHERE FHCODE = 'ITRQ' AND FHSRNO = '" + vID + "'  AND FHCONO = '"
                + comcono + "' AND FHDIVI = '" + comdivi + "'  ";
      ...
      String query3 = "UPDATE " + DBNAME + ".SR_FLOWHEAD " + "SET   FHDSTA = '" + newStatus
          + "' , FHENDA = CURRENT DATE ,FHENTI = CURRENT TIME WHERE FHCODE = 'ITRQ' AND FHSRNO = '"
          + vID + "'  AND FHCONO = '" + comcono + "' AND FHDIVI = '" + comdivi + "'  ";
  ...
  /*
   * 
   * public static String updateITEMREQUEST(String vID, String vSTATUS, String vData, String
   * vApproval) throws Exception { logger.info("UpdateITEMREQUEST");
   * 
   * JSONObject mJsonObj = new JSONObject(); Connection conn = null; Statement stmt = null;
   * 
   * 
   * String tt = "OK"; try {
   * 
   ...
   * 
   * if ("false".equalsIgnoreCase(vApproval)) { newStatus = "00"; } else { switch (vSTATUS) { case
   * "00": newStatus = "10"; break; case "10": newStatus = "20"; break; case "20": newStatus = "30";
   * break; case "30": newStatus = "40"; break; case "40": newStatus = "50"; break; case "50":
   * newStatus = "60"; break; case "60": newStatus = "22"; break; default: // ถ้าไม่ตรงเงื่อนไข
   ...
   * 
   * String query2 = "UPDATE BRLDTABK01.Approve_Detail SET JSON_DATA = '"+vData+"', STATUS = '"
   * +STATUS+10
   ...
   * tt= query;
   * 
   * logger.debug(query); logger.debug(query2); stmt.execute(query); stmt.execute(query2);
   * 
   * mJsonObj.put("result", "ok"); mJsonObj.put("message", "Update complete.");
   * 
   * return mJsonObj.toString();
   * 
   * } catch (SQLException e) { logger.error(e.getMessage()); } catch (Exception e) {
   * logger.error(e.getMessage()); } finally { try { if (stmt != null) { stmt.close(); } } catch
   * (SQLException e) { logger.error(e.getMessage()); } try { if (conn != null) { conn.close(); } }
  ...
  public static String UpdateRQ(String vID, String vCOM, String vWH, String vITM, String vAPV)
      throws Exception {
  ...
  public static String UpdateAP(String vID, String vAPVD, String vCOMAPVD) throws Exception {
    ...
    try {
      ...
      String query = "UPDATE  BRLDTABK01.VISITOR_HEAD   \n" + "SET H_TIMEOUT = '" + vAPVD
          + "' , H_EMPLOYEE = '" + vCOMAPVD + "', H_TEL='" + STATUS + "' \n" + "WHERE H_ID = '"
          + vID + "'";
      System.out.println("UpdateAP\n" + query);
      logger.debug(query);
      stmt.execute(query);
   ...
   * 
   * if ("true".equalsIgnoreCase(CHKSTATUS.trim())) { STATUS = "CP"; } else { STATUS = "RQ"; }
   * 
   * 
   * 
   ...
   * +vITAPVD+"' , H_ROOMNO = '"+vCOMITAPVD+"', H_TEL='"+STATUS+"' WHERE H_ID = '" +vID+"'";
   * System.out.println("UpdateAP\n" + query); logger.debug(query); stmt.execute(query);
   * 
   * mJsonObj.put("result", "ok"); mJsonObj.put("message", "Update complete.");
   * 
   * return mJsonObj.toString();
  ...
  public static String UpdateIT(String vID, String vITAPVD, String vCOMITAPVD) throws Exception {
    ...
    try {
      ...
      String query = "UPDATE BRLDTABK01.VISITOR_HEAD \n" + "SET " + "H_SURNAME = '"
          + vITAPVD.replace("'", "''") + "', " + "H_ROOMNO = '" + vCOMITAPVD.replace("'", "''")
          + "', " + "H_TEL = '" + STATUS + "' " + "WHERE H_ID = '" + vID.replace("'", "''") + "'";
  ...
  public static String updateemp(String vID, String vEmployeedialog, String vEmail,
      String getLocation, String vRemark, String vStatus, String vCheckin, String vCheckintime,
    ...
    try {
      ...
      String query = "　UPDATE  " + Constant.DBNAME + ".VISITOR_HEAD\r\n" + "　SET H_COMPANYNAME2 = '"
          + vEmployeedialog.trim() + "' ,H_STATUS ='" + checksts2 + "' , H_Email = '"
          + vEmail.trim() + "', H_REMARK1 = '" + vRemark.trim() + "' , H_CHECKIN ='" + vCheckin
          + "' , H_CHECKOUT = '" + vCheckout + "',H_CHECKINTIME = '" + vCheckintime
          + "',H_CHECKOUTTIME = '" + vCheckouttime + "' \r\n" + "　WHERE H_ID  =  '" + vID.trim()
  ...
  public static String updateroomcard(String vID, String vRoom, String vCard, String getLocation)
    ...
    try {
      ...
      String query = "　UPDATE  " + Constant.DBNAME + ".VISITOR_HEAD\r\n" + "　SET H_ROOMNO = '"
          + vRoom.trim() + "' , H_CARDNO = '" + vCard.trim() + "' \r\n" + "　WHERE H_ID  =  '"
          + vID.trim() + "' AND H_LOCATION = '" + getLocation.trim() + "'";
  ...
  public static String updatefollower(String vID, String H_SURNAME, String oldH_SURNAME,
      String vCONO, String vDIVI, String vLocaton) throws Exception {
    logger.info("updateSWRfile");
    ...
    try {
      ...
      String query = "　UPDATE  " + Constant.DBNAME + ".FOLLOWER_HEAD\r\n" + "　SET H_SURNAME = '"
          + H_SURNAME + "' \r\n" + "　WHERE F_ID  =  '" + vID.trim() + "' AND H_SURNAME = '"
          + oldH_SURNAME.trim() + "' AND  H_CONO = '" + vCONO.trim() + "' AND H_DIVI = '"
          + vDIVI.trim() + "' AND H_LOCATION = '" + vLocaton.trim() + "' ";
  ...
  public static String checkoutwithdatetime(String vID, String sts, String getLocation,
      String remark, String vcheckout, String vcheckouttime) throws Exception {
    ...
    try {
      ...
      String query = "　UPDATE  " + Constant.DBNAME + ".VISITOR_HEAD\r\n" + "　SET H_REMARK1 = '"
          ...
          + vID + "' AND H_LOCATION = '" + getLocation.trim() + "'";
      System.out.println("updateSWRfile\n" + query);
  ...
  public static String checkout(String vID, String sts, String getLocation, String remark)
      throws Exception {
    logger.info("updateSWRfile");
  ...
  public static String addvisitorheader(String vID, String vIMG, String vTimein, String vTimeout,
      String vLicense, String vName, String vSurname, String vTel, String vReason, String vEmployee,
      String vStatus, String vCono, String vCompany, String vMeetdate, String vMeettime,
      String vMail, InputStream imagefile, String imagename, String vCONO, String vDIVI,
      String vLocation, String vFoodnumber, String vATKnumber, String vParknumber, String vIstoken,
      String vETC, String vRoom, String vMeetdateout, String vMeettimeout, String vBeveragenumber,
      String vSnacksnumber, String vSandalsnumber, String username) throws Exception {
    logger.info("updateSWRfile");
    ...
    try {
      ...
      String query = "　UPDATE  " + Constant.DBNAME + ".VISITOR_HEAD\r\n" + "　SET H_LICENSE = '"
          + vLicense + "' , H_NAME = '" + vName + "', H_SURNAME = '" + vSurname + "' , H_TEL = '"
          + vTel + "', \r\n" + "　H_REASON = '" + vReason + "', H_COMPANYNAME2 = '" + vEmployee
          + "',H_STATUS = '" + vStatus + "' ,H_REMARK1 = '-' , H_COMPANYNAME= '" + vCompany
          + "' , H_MEETDATE = '" + vMeetdate + "' , H_MEETTIME = '" + vMeettime + "', H_IMG ='"
          + setImageName + "', H_ROOMNO = '" + vRoom.trim() + "', H_MEETDATEOUT = '" + vMeetdateout
          + "',H_MEETTIMEOUT = '" + vMeettimeout + "', H_USER = '" + username + "' \r\n"
          + "　WHERE H_ID  =  '" + vID + "' AND H_CONO = '" + vCONO.trim() + "' AND H_DIVI = '"
      ...
      if (vIstoken.equalsIgnoreCase("true")) {
        ...
        String query3 = "INSERT  INTO  " + Constant.DBNAME + ".VISITOR_ITEM \r\n"
            ...
            + "		　VALUES ('" + vCONO.trim() + "','" + vDIVI.trim() + "','" + vID + "','"
            + vFoodnumber + "','" + vATKnumber + "','" + vParknumber + "','" + vETC.trim()
            + "','0','0','0','" + vBeveragenumber + "','" + vSnacksnumber + "','" + vSandalsnumber
            + "')";
        System.out.println("updateSWRfile\n" + query2);
        logger.debug(query3);
        stmt.execute(query3);
  ...
  public static String updateSWRFile(String oldSFORNO, String oldSFCONO, String oldSFDIVI,
      String newSFORNO, String newSFPREF, String newSFLINE, String newSFNAME, String newSFTYPE,
      String newSFREM1, String newSFREM2, String getUsername) throws Exception {
    logger.info("updateSWRfile");
    ...
    try {
      ...
      String query = "UPDATE  " + DBNAME + ".M3_SWRFILE\r\n" + "			SET SFPREF = '"
          + newSFPREF + "' ,SFLINE = '" + newSFLINE + "',  SFNAME = '" + newSFNAME + "',SFTYPE ='"
          + newSFTYPE + "',SFREM1 = '" + newSFREM1 + "' , SFREM2 = '" + newSFREM2
          + "' WHERE SFORNO = '" + oldSFORNO + "' AND SFCONO= '" + oldSFCONO + "' AND SFDIVI = '"
          + oldSFDIVI + "'";
      System.out.println("updateSWRfile\n" + query);
      logger.debug(query);
      stmt.execute(query);
  ...
  public static String updateStatusMARHead(String cono, String divi, String marno, String status,
  ...
  public static String updateMARDetail(String cono, String divi, String marno, String prefix,
      String refno, String typeadjust, String line, String item, String name, String fac,
      String whs, String loc, String lotno, String date, String unit, String qty, String price,
      String amt, String remark1, String remark2, String status, String username) throws Exception {
  ...
  public static String updateADRHead(String cono, String divi, String adrno, String date,
      String month, String type, String prefix, String boi, String bu, String costcenter,
      String vat, String accountant, String requestor, String remark1, String approve1,
      String approve2, String approve3, String approve4, String status, String submit,
  ...
  public static String updateADRDetail(@Context HttpServletRequest httpServletRequest, String cono,
      String divi, String adrno, String prefix, String line, String itemno, String sbno,
      String costcenter, String date, String assetcost, String netvalue, String qty, String price,
      String remark, InputStream imagefile, String imagename, String status, String submit,
      String username) throws Exception {
  ...
  public static String updateADRImage(@Context HttpServletRequest httpServletRequest, String cono,
      String divi, String adrno, InputStream imagefile, String imagename, String username)
      throws Exception {
  ...
  public static String updateStatusADRHead(@Context HttpServletRequest httpServletRequest,
      String cono, String divi, String adrno, String tostatus, String submit, String username)
      throws Exception {
  ...
  public static String updateStatusADRDetail(String cono, String divi, String adrno, String status,
      String submit, String username) throws Exception {
  ...
  public static String updateRejectADRHead(@Context HttpServletRequest httpServletRequest,
      String cono, String divi, String adrno, String remark, String accremark, String appremark1,
      String appremark2, String appremark3, String appremark4, String fromstatus, String submit,
      String username) throws Exception {
  ...
  public static String deleteidmove(String getCono, String ID, String GROUP_ID) throws Exception {
    ...
    try {
      if (conn != null) {
         ...
         * "	     WHERE BM_CONO  = '"+getCono+"' AND BM_ID = '" + ID + "' AND BM_CUNO  ='-'";
         */
  ...
  public static String deleteid(String getCono, String getDivi, String ID, String BM_CONO,
      String BM_PARENT, String GROUP_ID, String H_RNNO, String CHECKTYPE) throws Exception {
    ...
    try {
      if (conn != null) {
        ...
        String query = "UPDATE " + DBNAME + ".BANK_MAPPING\r\n"
            ...
            + getCono + "' AND BM_ID = '" + ID + "' AND BM_PARENT_STS  ='77'";
        stmt.executeUpdate(query);
    ...
    try {
      if (conn != null) {
        ...
        String query = "  UPDATE  " + DBNAMEPP + ".BANK_MAPPING  \n"
            ...
            + "  WHERE   BM_FNNO  = '" + GROUPID.trim() + "' AND BM_CONO  = '" + CONO.trim() + "' ";
        ...
        String query3 = "DELETE FROM   " + DBNAMEPP + ".LR_LINERECEIPT\n"
            ...
            + ".HR_RECEIPT hr WHERE  HC_FNNO = '" + GROUPID.trim() + "' ) AND LR_CONO  = '"
            + CONO.trim() + "' ";
  ...
  public static String savehead(String H_CONO, String H_DIVI, String H_RNNO, String H_RCNO,
      String H_CUNO, String H_PYNO, String H_STS, String H_VCNO, String H_LOCATION, String H_TYPE)
      throws Exception {
    ...
    try {
      if (conn != null) {
        ...
        String query = " UPDATE  " + Constant.DBNAME + ".HEAD_RECIPT\r\n" + "  SET H_RNNO = '"
            + H_RNNO + "',H_CUNO = '" + H_CUNO + "',H_PYNO = '" + H_PYNO + "',H_STS = '" + H_STS
            + "',H_VCNO = '" + H_VCNO + "',H_LOCATION = '" + H_LOCATION + "',H_TYPE= '" + H_TYPE
            + "'\r\n" + "  WHERE H_CONO = '" + H_CONO + "'\r\n" + "  AND H_DIVI  = '" + H_DIVI
            + "'\r\n" + "  AND H_RCNO = '" + H_RCNO + "'";
        stmt.executeUpdate(query);
  ...
  public static String savemapping(String BM_ID, String BM_CONO, String BM_DIVI, String BM_BANK,
      String BM_ACCODE, String BM_DATE, String BM_TIME, String BM_CHQNO, String BM_CUNO,
      String BM_AMOUNT, String BM_DESC, String BM_RCNO, String BM_USER, String BM_BKCHARGE,
      String BM_OVPAY, String BM_CNDN, String BM_STATUS, String BM_FNNO, String BM_LCODE,
      String BM_PARENT_ID, String BM_PARENT_STS) throws Exception {
    ...
    try {
      if (conn != null) {
        ...
        String query = "  UPDATE  " + Constant.DBNAME + ".BANK_MAPPING \r\n" + "  SET BM_CONO = '"
            + BM_CONO + "',BM_DIVI = '" + BM_DIVI + "',BM_BANK = '" + BM_BANK + "',BM_ACCODE = '"
            + BM_ACCODE + "',BM_DATE = '" + BM_DATE + "',BM_TIME = '" + BM_TIME + "',BM_CHQNO = '"
            + BM_CHQNO + "',BM_CUNO = '" + BM_CUNO + "',BM_AMOUNT = '" + BM_AMOUNT + "',BM_DESC = '"
            + BM_DESC + "',BM_RCNO = '" + BM_RCNO + "',\r\n" + "  BM_USER = '" + BM_USER
            + "',BM_BKCHARGE = '" + BM_BKCHARGE + "',BM_OVPAY = '" + BM_OVPAY + "',BM_CNDN = '"
            + BM_CNDN + "',BM_STATUS = '" + BM_STATUS + "',BM_FNNO = '" + BM_FNNO + "',BM_LCODE = '"
            + BM_LCODE + "',BM_PARENT_ID = '" + BM_PARENT_ID + "',BM_PARENT_STS = '" + BM_PARENT_STS
            + "'\r\n" + "  WHERE BM_ID = '" + BM_ID + "'";
        stmt.executeUpdate(query);
  ...
  public static String savehcrc(String HR_CONO, String HR_DIVI, String HC_RCNO, String HC_TRDT,
      String HC_PYNO, String HC_REAMT, String HC_TYPE, String HC_BANK, String HC_ACCODE,
      String HC_PYDT, String HC_CHKNO, String HC_USER, String HC_VCNO, String HC_STS,
      String HR_BKCHG, String HC_LOCATION, String HC_FIXNO, String HC_FNNO) throws Exception {
    ...
    try {
      if (conn != null) {
        ...
        String query = " UPDATE  " + Constant.DBNAME + ".HR_RECEIPT \r\n" + "  SET HC_TRDT = '"
            + HC_TRDT + "',HC_PYNO = '" + HC_PYNO + "',HC_REAMT = '" + HC_REAMT + "',HC_TYPE = '"
            + HC_TYPE + "',\r\n" + "  HC_BANK = '" + HC_BANK + "',HC_ACCODE = '" + HC_ACCODE
            + "',HC_PYDT = '" + HC_PYDT + "',HC_CHKNO = '" + HC_CHKNO + "',HC_USER = '" + HC_USER
            + "',HC_VCNO = '" + HC_VCNO + "',HC_STS = '" + HC_STS + "',HR_BKCHG = '" + HR_BKCHG
            + "',\r\n" + "  HC_LOCATION = '" + HC_LOCATION + "',HC_FIXNO = '" + HC_FIXNO
  ...
  public static String savelnrc(String LR_CONO, String LR_DIVI, String LR_RCNO, String LR_INVNO,
      String LR_INVDT, String LR_INVAMT, String LR_REAMT, String LR_STS) throws Exception {
    ...
    try {
      if (conn != null) {
        ...
        String query = "UPDATE  " + Constant.DBNAME + ".LR_LINERECEIPT  \r\n" + "  SET LR_INVNO = '"
            + LR_INVNO + "',LR_INVDT = '" + LR_INVDT + "',LR_INVAMT = '" + LR_INVAMT
  ...
  public static String addstatement(String getCono, String getDivi, String BANK, String BANKCODE,
      String DATE1, String TIME, String AMOUNT, String DESC, String REFCUS, String LCODE,
  ...
  public static String saveid(String getCono, String getDivi, String ID, String PAYER,
      String BANKCHARGE, String OVERPAY, String CNDN, String TYPE, String GROUPID, String LOCATION)
      throws Exception {
    ...
    try {
      if (conn != null) {
        ...
        String query = "UPDATE " + DBNAMEPP + ".BANK_MAPPING\r\n" + "		 SET BM_FNNO = '"
            + GROUPID + "', BM_RCNO = '" + hcRcno + "'  , BM_BKCHARGE = '" + BANKCHARGE
            + "', BM_OVPAY = '" + OVERPAY + "' , BM_CNDN = '" + CNDN + "' \r\n"
            + "	     WHERE BM_CONO  = '" + getCono + "' AND BM_ID = '" + ID
            + "' AND BM_PARENT_STS  ='77'";
        stmt.executeUpdate(query);

        String query2 = "UPDATE " + DBNAMEPP + ".HEAD_RECIPT\r\n" + "		 SET H_LOCATION = '"
            + LOCATION + "', H_TYPE = '" + TYPE + "' \r\n" + "	     WHERE H_CONO  = '" + getCono
            + "' AND H_RNNO = '" + GROUPID + "'";
        stmt.executeUpdate(query2);
         ...
         * 
         * System.out.println(query); Statement stmt2 = conn.createStatement(); String query2 =
         * "UPDATE "+DBNAME+".HEAD_RECIPT SET  H_PYNO = '" + PAYER.toUpperCase() +
         * "', H_LOCATION = '" + LOCATION + "' , H_TYPE = '" + TYPE + "' , H_CUNO = 'HEAD' \n" +
         * "WHERE H_RNNO  = '" + GROUPID + "' \n" + "AND H_CONO  = '10' AND H_STS = 1 \n" +
         * "AND H_DIVI  = '101'"; System.out.println(query2); stmt2.executeUpdate(query2);
         * 
         */
  ...
  public static String UPDATEID(String getCono, String getDivi, String BMDATE, String ID,
      String PAYER, String BANKCHARGE, String OVERPAY, String CNDN, String TYPE, String LOCATION,
      String GROUPID, String BMAMT) throws Exception {
  ...
  public static String CREATEID(String getCono, String getDivi, String BMDATE, String ID,
      String PAYER, String BANKCHARGE, String OVERPAY, String CNDN, String TYPE, String LOCATION,
      String GROUPID, String BMAMT, String BANKTYPE) throws Exception {
    ...
    try {
      if (conn != null) {
        ...
        String sqlFNNO =
            "SELECT CASE WHEN CAST(MAX(H_RNNO) AS DECIMAL(10,0)) > 0 THEN CAST(MAX(H_RNNO) AS DECIMAL(10,0)) + 1\r\n"
                + "                           ELSE CAST(('" + yearint
        ...
        sqlhead = "INSERT INTO " + DBNAME + ".HEAD_RECIPT\n" + "(H_CONO, H_DIVI, H_CUNO, H_RCNO, \n"
            ...
            + getDivi + "','HEAD', 9 || " + BM_FNNO + " ,  \n" + " '" + BM_FNNO + "' ,'"
            + PAYER.trim().toUpperCase() + "' , '1' , '" + LOCATION + "' , '" + TYPE + "'\n" + " \n"
            + " )";
  ...
  public static String updateOrderHead(String cono, String divi, String orderno, String orderdate,
      String delidate, String round, String pricelist, String ordertype, String whs, String status,
      String type, String remark, String pono, String userid) throws Exception {
  ...
  public static String updateStatusOrderHead(String cono, String divi, String orderno,
  ...
  public static String updateStatusOrderHeadPrintCO(String cono, String divi, String fromco,
      String toco, String updatestatus, String fromstatus, String tostatus, String credit,
      String auth, String userid) throws Exception {
      ...
      if (conn != null) {
        ...
        if (auth.equals("1")) {
          ...
          String query = "UPDATE " + DBNAME + ".M3_TAKEORDERHEAD \n" + "SET THSTAS = '"
              ...
              + DBNAME + ".M3_TAKEORDERHEAD a, " + DBNAME + ".M3_TAKEORDERDETAILSUPPORT b, "
              + DBM3NAME + ".OOHEAD c \n" + "WHERE THCONO = '" + cono + "' \n" + "AND THDIVI = '"
              + divi + "'  \n" + "AND b.TDCONO = THCONO \n" + "AND b.TDDIVI = THDIVI \n"
  ...
  public static String updateStatusOrderHeadPrintCOV2(String cono, String divi, String fromco,
      String toco, String updatestatus, String fromstatus, String tostatus, String credit,
      String auth, String userid) throws Exception {
      ...
      if (conn != null) {
        ...
        if (auth.equals("1")) {
          ...
          String query = "UPDATE " + DBNAME + ".M3_TAKEORDERHEAD \n" + "SET THSTAS = '"
              ...
              + DBM3NAME + ".OOHEAD c \n" + "WHERE THCONO = '" + cono + "' \n" + "AND THDIVI = '"
              + divi + "'  \n" + "AND THSTAS = '92' \n" + "AND b.TDCONO = THCONO \n"
              + "AND b.TDDIVI = THDIVI \n" + "AND b.TDORNO = THORNO \n" + "AND b.TDCONU BETWEEN '"
              + fromco + "' AND '" + toco + "' \n" + "AND (c.OAORST = '" + fromstatus
              + "' AND c.OAORSL = '" + tostatus + "') \n" + "AND c.OAOBLC IN (" + credit + ") \n"
              + "AND c.OACONO = THCONO \n" + "AND c.OAORNO = b.TDCONU \n"
              // + "AND c.OARESP = '"+userid+"' \n"
              + "GROUP BY THORNO)";
  ...
  public static String updateStatusOrderHeadInvNumber(String cono, String divi, String orderno,
  ...
  public static String updateItemDetail(String cono, String divi, String orderno, String line,
      String qty, String unit, String remark, String userid) throws Exception {
  ...
  public static String updateItemDetailUpdate(String cono, String divi, String orderno, String line,
      String qty, String remark, String userid) throws Exception {
  ...
  public static String updateItemDetailSupport(String cono, String divi, String orderno,
      String line, String qty, String unit, String remark, String remark2, String userid)
      throws Exception {
  ...
  public static String updateCONumberItemDetailSupport(String cono, String divi, String orderno,
      String conumber, String status) throws Exception {
  ...
  public static String updateUser(String cono, String divi, String username, String status)
      throws Exception {
  ...
  public static String updateOrderHeadCO(String cono, String divi, String orderno, String delidate,
  ...
  public static String resetAuthTakeorder(String cono, String divi, String status)
      throws Exception {
  ...
  public static String updateODHEAD(String cono, String divi, String orderno, String userid)
      throws Exception {
  ...
  public static String updateOOHEAD(String cono, String divi, String orderno, String userid)
      throws Exception {
  ...
  public static String updateSurveyHeadTitle(String cono, String divi, String servicename,
      String serviceno, String status, String title, String username) throws Exception {
    logger.info("updateSurveyHeadDesc");
    ...
    try {
      ...
      String query = "UPDATE " + DBNAME + ".SR_FLOWHEAD \n" + "SET FHDES1 = '" + title + "' \n"
          + ", FHENDA = CURRENT DATE \n" + ", FHENTI = CURRENT TIME \n" + ", FHENUS = '" + username
          + "' \n" + "WHERE FHCONO = '" + cono + "' \n" + "AND FHDIVI = '" + divi + "' \n"
          + "AND FHCODE = '" + servicename + "' \n" + "AND FHSRNO = '" + serviceno + "'\n"
          + "AND FHDSTA = '" + status + "'";
      // System.out.println("updateMARDetail\n" + query);
      logger.debug(query);
      stmt.execute(query);
  ...
  public static String updateSurveyFlowApproveBy(String cono, String divi, String servicename,
      String serviceno, String fromstatus, String remark, String username) throws Exception {
    logger.info("updateSurveyFlowApproveBy");
  ...
  public static String prepareUpdateSoftwareForm(String cono, String divi, String servicename,
      String serviceno, String requesttype, String status, String data, List<FormDataBodyPart> file,
      List<FormDataBodyPart> filename, List<FormDataBodyPart> fieldname) throws Exception {
    logger.info("prepareUpdateSurveyForm");

    JSONObject mJsonObj = new JSONObject();
    try {
      logger.debug("Update");
      JSONObject dataObject = new JSONObject(data);
      Boolean getApproval = Boolean.valueOf(dataObject.getString("vApproval"));
      ...
      if (getVersion == null || getVersion.isEmpty() || !Objects.equals(checkVersion, getVersion)) {
        mJsonObj.put("result", "nok");
        mJsonObj.put("message", "Can't Create service number, Please update your version to "
            + checkVersion + " :  " + getVersion + " (Click F5 button).");
        return mJsonObj.toString();

      }

      String getApprover = "", getStatus = "", getNextStatus = "", getNextApprover = "",
          getNextGroup = "", getPreviousStatus = "", getPreviousApprover = "";
      String setDefaultStatus = status, setStatus = status;
      Boolean checkVacant = true;
      while (checkVacant) {
        String[] getStatusFlowApprove = SelectData
            .getStatusFlowApprove(cono, divi, servicename, serviceno, setStatus).split(";");
        getApprover = getStatusFlowApprove[0].trim();
        getStatus = getStatusFlowApprove[1].trim();
        getNextStatus = getStatusFlowApprove[2].trim();
        getNextApprover = getStatusFlowApprove[3].trim();
        getNextGroup = getStatusFlowApprove[4].trim();
        getPreviousStatus = getStatusFlowApprove[5].trim();
        getPreviousApprover = getStatusFlowApprove[6].trim();
        logger.info("getGroup {}, getApprover {}, approval {}, getStatus {}", getApprover,
            getApproval, getStatus);
        logger.info("getNextStatus {}, getNextApprover {}, getNextGroup {}", getNextStatus,
            getNextApprover, getNextGroup);
        logger.info("getPreviousStatus {}, getPreviousApprover {}", getPreviousStatus,
            getPreviousApprover);

        // Re Update Depthead
        if (getNextGroup.equals("DEPTHEAD")) {
          if (!getNextApprover.equals(getDepthead)) {
            updateSurveyUserHead(cono, divi, servicename, serviceno, setDefaultStatus, getApproveBy,
                getDepthead);
            updateSurveyUserFlowApprove(cono, divi, servicename, serviceno, getNextStatus,
                getApproveBy, getDepthead);
          }

        }

        if (getNextApprover.equals("VACANT")) {
      ...
      if (getApproval) {
        String approveBy =
            SelectData.checkApproveBy(cono, divi, servicename, serviceno, setDefaultStatus);
        if (approveBy.equals("")) {
          // Update Head
          updateSurveyHead(cono, divi, servicename, serviceno, setDefaultStatus, getNextStatus,
              getApproveBy, getDepthead);

          // Update Detail
          updateSurveyDetail(cono, divi, servicename, serviceno, setDefaultStatus, getNextStatus,
              data, getApproveBy);

          // Update Flow Approve
          updateSurveyFlowApproveBy(cono, divi, servicename, serviceno, setDefaultStatus, getRemark,
              getApproveBy);

          // Update File
          if (file != null && !file.isEmpty()) {
            FileUtillity.prepareUpdateToFileServer(cono, divi, servicename, serviceno, file,
                fieldname, getApproveBy);
          }

          // Mark Complete Order
          if (setStatus.equals(getNextStatus)) {
            // 3 = Approve Complete
            updateSurveyHeadStatus(cono, divi, servicename, serviceno, setDefaultStatus, "3",
                getApproveBy);
          } else {
            // 2 = Wait for approve
            updateSurveyHeadStatus(cono, divi, servicename, serviceno, getPreviousStatus, "2",
                getApproveBy);
          }

        } else {
          mJsonObj.put("result", "nok");
          mJsonObj.put("message", "Can't approve, Service approve already by " + approveBy);
          return mJsonObj.toString();
        }
        ...
        if (approveBy.equals("")) {
          // Update Head
          updateSurveyHead(cono, divi, servicename, serviceno, setDefaultStatus, getPreviousStatus,
              getApproveBy, getDepthead);

          // Update Detail
          updateSurveyDetail(cono, divi, servicename, serviceno, setDefaultStatus,
              getPreviousStatus, data, getApproveBy);

          // Update Flow Approve
          updateSurveyFlowReject(cono, divi, servicename, serviceno, setDefaultStatus, getRemark,
              getApproveBy);
          updateSurveyFlowRejectBy(cono, divi, servicename, serviceno, setDefaultStatus, getRemark,
              getApproveBy);

          // Mark Reject Order
          if (setStatus.equals(getPreviousStatus)) {
            // 9 = Cancel Complete
            updateSurveyHeadStatus(cono, divi, servicename, serviceno, getPreviousStatus, "9",
                getApproveBy);
          } else {
            // 1 = Wait for submit
            updateSurveyHeadStatus(cono, divi, servicename, serviceno, getPreviousStatus, "1",
                getApproveBy);
          }

        } else {
          mJsonObj.put("result", "nok");
          mJsonObj.put("message", "Can't reject, Service approve already by " + approveBy);
          return mJsonObj.toString();
        }
      }
      ...
      body.put("status", getApproval ? getNextStatus : getPreviousStatus);
  ...
  public static String updateSurveyHeadStatus(String cono, String divi, String servicename,
      String serviceno, String fromstatus, String tostatus, String username) throws Exception {
    logger.info("updateSurveyHeadStatus");
  ...
  public static String updateSurveyFile(String cono, String divi, String servicename,
      String serviceno, String fieldname, String originalFileName, String filetype,
      String newFileName, String username) throws Exception {
    logger.info("updateSurveyFile");
    ...
    try {
      ...
      String query = "UPDATE " + DBNAME + ".SR_FILE \n" + "SET FIFNAM = '" + originalFileName
          + "' \n" + ", FITYPE = '" + filetype + "' \n" + ", FIREM1 = '" + newFileName + "' \n"
          + ", FIENDA = CURRENT DATE \n" + ", FIENTI = CURRENT TIME \n" + ", FIENUS = '" + username
          + "' \n" + "WHERE FICONO = '" + cono + "' \n" + "AND FIDIVI = '" + divi + "' \n"
  ...
  public static String updateSurveyDetail(String cono, String divi, String servicename,
      String serviceno, String fromstatus, String tostatus, String data, String username)
      throws Exception {
    logger.info("updateSurveyDetail");
    ...
    try {
      ...
      String query = "UPDATE " + DBNAME + ".SR_FLOWDETAIL \n" + "SET FDDATA = '" + data + "' \n"
          ...
          + ", FDENDA = CURRENT DATE \n" + ", FDENTI = CURRENT TIME \n" + ", FDENUS = '" + username
          + "' \n" + "WHERE FDCONO = '" + cono + "' \n" + "AND FDDIVI = '" + divi + "' \n"
          + "AND FDCODE = '" + servicename + "' \n" + "AND FDSRNO = '" + serviceno + "'";
      // System.out.println("updateMARDetail\n" + query);
      logger.debug(query);
      stmt.execute(query);
  ...
  public static String updateSurveyUserHead(String cono, String divi, String servicename,
      String serviceno, String status, String username, String depthead) throws Exception {
    logger.info("updateSurveyUserHead");
  ...
  public static String updateSurveyHead(String cono, String divi, String servicename,
      String serviceno, String fromstatus, String tostatus, String username, String depthead)
      throws Exception {
    logger.info("updateSurveyHead");
  ...
  public static String updateSurveyFlowReject(String cono, String divi, String servicename,
      String serviceno, String fromstatus, String remark, String username) throws Exception {
    logger.info("updateSurveyFlowReject");
  ...
  public static String updateSurveyFlowRejectBy(String cono, String divi, String servicename,
      String serviceno, String fromstatus, String remark, String username) throws Exception {
    logger.info("updateSurveyFlowRejectBy");
