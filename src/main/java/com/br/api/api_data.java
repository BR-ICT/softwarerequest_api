...
public class api_data {
	...
	public Response addheadervisitor(@Context HttpHeaders headers, @Context HttpServletRequest httpServletRequest,
			@FormDataParam("vCONO") String vCONO, @FormDataParam("vDIVI") String vDIVI,
			@FormDataParam("vLocation") String vLocation)
			throws JSONException {
		...
		try {
			...
			return Response
					.ok(InsertData.addvisitorheader(vCONO, vDIVI, vLocation),
							MediaType.APPLICATION_JSON + ";charset=utf8")
					.build();
	...
	public Response inserteditTEST(@Context HttpHeaders headers, @Context HttpServletRequest httpServletRequest,
			@FormDataParam("vData") String vData, @FormDataParam("username") String username,
			@FormDataParam("depthead") String depthead, @FormDataParam("remark") String remark)
			throws JSONException {
		logger.info("/insertRQ");
		...
		try {
			...
			return Response
					.ok(InsertData.inserteditTEST(vData, username, depthead),
							MediaType.APPLICATION_JSON + ";charset=utf8")
					.build();
	 ...
	 * @Consumes(MediaType.MULTIPART_FORM_DATA)
	 * 
	 * public Response insertRQ(@Context HttpHeaders headers, @Context
	 * HttpServletRequest httpServletRequest, @FormDataParam("vID") String
	 * vID, @FormDataParam("vCOM") String vCOM,@FormDataParam("vWH") String
	 * vWH,@FormDataParam("vITM") String vITM,@FormDataParam("vAPV") String vAPV)
	 * throws JSONException {
	 * logger.info("/insertRQ");
	 * 
	 * JSONObject mJsonObj = new JSONObject();
	 ...
	 * try {
	 * 
	 * return Response.ok(InsertData.insertRQ(vID,vCOM,vWH,vITM,vAPV),
	 * MediaType.APPLICATION_JSON + ";charset=utf8")
	 * .build();
	 * 
	 * } catch (Exception e) {
	 ...
	 * @Consumes(MediaType.MULTIPART_FORM_DATA)
	 * 
	 * public Response UpdateIT(@Context HttpHeaders headers, @Context
	 * HttpServletRequest httpServletRequest, @FormDataParam("vID") String
	 * vID, @FormDataParam("vITAPVD") String vITAPVD,@FormDataParam("vCOMITAPVD")
	 * String vCOMITAPVD)
	 * throws JSONException {
	 * logger.info("/insertRQ");
	 * 
	 ...
	 * try {
	 * 
	 * return Response.ok(UpdateData.UpdateIT(vID,vITAPVD,vCOMITAPVD),
	 * MediaType.APPLICATION_JSON + ";charset=utf8")
	 * .build();
	 * 
	 * } catch (Exception e) {
	 ...
	 * @Consumes(MediaType.MULTIPART_FORM_DATA)
	 * 
	 * public Response UpdateRQ(@Context HttpHeaders headers, @Context
	 * HttpServletRequest httpServletRequest, @FormDataParam("vID") String
	 * vID, @FormDataParam("vCOM") String vCOM,@FormDataParam("vWH") String
	 * vWH,@FormDataParam("vITM") String vITM,@FormDataParam("vAPV") String vAPV)
	 * throws JSONException {
	 ...
	 * try {
	 * 
	 * return Response.ok(UpdateData.UpdateRQ(vID,vCOM,vWH,vITM,vAPV),
	 * MediaType.APPLICATION_JSON + ";charset=utf8")
	 * .build();
	 * 
	 * } catch (Exception e) {
	 ...
	 * @Consumes(MediaType.MULTIPART_FORM_DATA)
	 * 
	 * public Response UpdateAP(@Context HttpHeaders headers, @Context
	 * HttpServletRequest httpServletRequest, @FormDataParam("vID") String
	 * vID, @FormDataParam("vAPVD") String vAPVD,@FormDataParam("vCOMAPVD") String
	 * vCOMAPVD)
	 * throws JSONException {
	 * logger.info("/insertRQ");
	 * 
	 ...
	 * try {
	 * 
	 * return Response.ok(UpdateData.UpdateAP(vID,vAPVD,vCOMAPVD),
	 * MediaType.APPLICATION_JSON + ";charset=utf8")
	 * .build();
	 * 
	 * } catch (Exception e) {
	...
	public Response testwf(@Context HttpHeaders headers, @Context HttpServletRequest httpServletRequest,
			@FormDataParam("vCONO") String vCONO)
			throws JSONException {
		logger.info("/addheadervisitor");
	...
	public Response savehead(
		...
		try {
			...
			return Response.ok(
					UpdateData.savemapping(BM_ID, BM_CONO, BM_DIVI, BM_BANK, BM_ACCODE, BM_DATE, BM_TIME, BM_CHQNO,
							BM_CUNO, BM_AMOUNT, BM_DESC, BM_RCNO, BM_USER, BM_BKCHARGE, BM_OVPAY, BM_CNDN, BM_STATUS,
							BM_FNNO, BM_LCODE, BM_PARENT_ID, BM_PARENT_STS),
					MediaType.APPLICATION_JSON + ";charset=utf8").build();
	...
	public Response savehead(
		...
		try {
			...
			return Response.ok(
					UpdateData.savehcrc(HR_CONO, HR_DIVI, HC_RCNO, HC_TRDT, HC_PYNO, HC_REAMT, HC_TYPE, HC_BANK,
							HC_ACCODE, HC_PYDT, HC_CHKNO, HC_USER, HC_VCNO, HC_STS, HR_BKCHG, HC_LOCATION, HC_FIXNO,
							HC_FNNO),
					MediaType.APPLICATION_JSON + ";charset=utf8").build();
	...
	@Path("/checkinv/{IVS}")
	@Produces(MediaType.APPLICATION_JSON + ";charset=utf-8")
	public Response checkinv(@Context HttpHeaders headers, @PathParam("IVS") String IVS, String req)
			throws JSONException {
	...
	public Response addstatement(
		...
		try {
			...
			return Response.ok(
					UpdateData.addstatement(getCono, getDivi, BANK, BANKCODE, DATE1, TIME, AMOUNT, DESC, REFCUS, LCODE,
							CUSTOMERNAME),
					MediaType.APPLICATION_JSON + ";charset=utf8").build();
	...
	public Response updateonly(
		...
		try {
			...
			if (GROUPID.equalsIgnoreCase("-")) {
				...
				return Response.ok(
						UpdateData.CREATEID(getCono, getDivi, BMDATE, ID, PAYER, BANKCHARGE, OVERPAY, CNDN, TYPE,
								LOCATION, GROUPID, BMAMT, BANKTYPE),
						MediaType.APPLICATION_JSON + ";charset=utf8").build();
			} else {
				return Response.ok(
						UpdateData.UPDATEID(getCono, getDivi, BMDATE, ID, PAYER, BANKCHARGE, OVERPAY, CNDN, TYPE,
								LOCATION, GROUPID, BMAMT),
						MediaType.APPLICATION_JSON + ";charset=utf8").build();
		...
		if (getToken != null && !getToken.isEmpty()) {
			...
			if (checkToken) {
				...
				try {
					...
					return Response.ok(
							SendEmail.prepareEmailFAP(httpServletRequest, getCono, getDivi, prefix, ordno, status,
									status, submit, getUsername, getToken, getLocation, foodcheck, foodqty, atkcheck,
									atkqty, parkcheck, parkqty, etc, beveragecheck, beveragenumber, snackcheck,
									snacksnumber, sandalcheck, sandalnumber, meetdate, meettime, meetdateout,
									meettimeout, room, company, name, surname),
							MediaType.APPLICATION_JSON + ";charset=utf8").build();
